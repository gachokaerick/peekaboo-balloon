...
public final class RxExtensKt {
    ...
    android.arch.lifecycle.LiveData<T> $receiver) {
        return null;
    }
    
    public static final <T extends java.lang.Object>void set(@org.jetbrains.annotations.NotNull()
    android.arch.lifecycle.MutableLiveData<T> $receiver, @org.jetbrains.annotations.Nullable()
    T value) {
    }
    
    @org.jetbrains.annotations.Nullable()
    public static final <T extends java.lang.Object>T get(@org.jetbrains.annotations.NotNull()
    android.arch.lifecycle.MutableLiveData<T> $receiver) {
        return null;
    }
    
    @org.jetbrains.annotations.NotNull()
    public static final <T extends java.lang.Object>android.arch.lifecycle.MediatorLiveData<T> init(@org.jetbrains.annotations.NotNull()
    android.arch.lifecycle.MutableLiveData<T> $receiver, @org.jetbrains.annotations.Nullable()
    T t) {
        return null;
    }
